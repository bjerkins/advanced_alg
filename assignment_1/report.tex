...
\subsection*{Exercise 2.4}
  ...
  Based on the previously stated variables, we can now count the total number of breakpoints in the rectiliniar layout as the following:
  $$\sum_{f \in F}\sum_{g \in F \setminus f} z_{fg}$$
...
In Section 3.1 we saw that in the worse case we would add at most $2E$ edges and $E$ vertices. In Section 3.3 we saw that we would add at most $E$ edges and $E$ vertices.\\
